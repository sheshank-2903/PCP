        ...
        if(getIntent().getStringExtra("from").toString().equals("signUp")){
            ...
            saveProfile.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    data.put("profilePicture" , "https://firebasestorage.googleapis.com/v0/b/rase-ba33b.appspot.com/o/profile%2FWhatsApp%20Image%202021-12-16%20at%2019.39.06.jpeg?alt=media&token=c2e4e2d5-4176-4241-b34c-48d7c29abc77");
